			<h2>Percentage dimensions of the double page layout</h2>
			<img src="http://matthewjamestaylor.com/blog/perfect-2-column-double-page-dimensions.gif" width="350" height="370" alt="Two column double page layout dimensions" />
			...
			<dl>
				...
				<dd>Left &amp; right columns: 357 pixels</dd>
				<dt><strong>1024 x 768</strong></dt>
				<dd>Left &amp; right columns: 459 pixels</dd>
			</dl>
			<h2>The nested div structure</h2>
			<p>I've colour coded each div so it's easy to see:</p>
			<img src="http://matthewjamestaylor.com/blog/perfect-2-column-double-page-div-structure.gif" width="350" height="369" alt="Two column double page layout nested div structure" />
