...
/*
	While storing this as raw MySQL data would make the insert more efficient, I chose this
...
// The Bible, in an array, which gets input into a database.
$books = array(
...
// create the sermon ranges table if it doesn't exist (don't want to delete data!)
...
// create the bible verse id table if it doesn't exist (deleting it will break sermon verse ranges!)
...
// create the bible book ids (see precaution above!)
